...
public interface CosmicCoreRecipeSchema {
    ...
    class CosmicRecipeJS extends GTRecipeSchema.GTRecipeJS {
        ...
        public GTRecipeSchema.GTRecipeJS sourceInput(int source) {
            return this.input(SourceRecipeCapability.CAP, source);
        }

        public GTRecipeSchema.GTRecipeJS sourceOutput(int source) {
            return this.output(SourceRecipeCapability.CAP, source);
        }
    }
