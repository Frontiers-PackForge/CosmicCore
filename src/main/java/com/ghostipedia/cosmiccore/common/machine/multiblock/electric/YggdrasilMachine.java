...
public class YggdrasilMachine extends MagnetWorkableElectricMultiblockMachine implements ITieredMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(com.ghostipedia.cosmiccore.common.machine.multiblock.electric.MagneticFieldMachine.class, MagnetWorkableElectricMultiblockMachine.MANAGED_FIELD_HOLDER);
    @Getter
    ...
    public YggdrasilMachine(IMachineBlockEntity holder) {
        super(holder);
    }
