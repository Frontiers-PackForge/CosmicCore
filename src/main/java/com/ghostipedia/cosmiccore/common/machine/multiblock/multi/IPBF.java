...
import static com.ghostipedia.cosmiccore.api.machine.part.CosmicPartAbility.STEAM_IMPORT_FLUIDS;
            ...
            .pattern(definition -> MultiblockPatternBuilder
                    ...
                    .where('Q', blocks(FIREBOX_STEEL.get()).setMinGlobalLimited(6)
                            ...
                            .or(Predicates.abilities(PartAbility.STEAM_EXPORT_ITEMS).setPreviewCount(1)
                                    .setExactLimit(1))
                            .or(Predicates.abilities(STEAM_IMPORT_FLUIDS).setPreviewCount(1).setExactLimit(1)))
                    .build())
