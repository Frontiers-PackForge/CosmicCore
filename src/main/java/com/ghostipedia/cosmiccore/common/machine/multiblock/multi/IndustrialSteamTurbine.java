...
public class IndustrialSteamTurbine {

    public final static MultiblockMachineDefinition LARGE_EMBER_COMPRESSOR = REGISTRATE
            .multiblock("large_ember_boiler", WorkableElectricMultiblockMachine::new)
