...
public class DreamersBasin {
    ...
    public static final MultiblockMachineDefinition DREAMERS_BASIN = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("  AAA   AAA  ", "    A   A    ", "    A   A    ", "      B      ", "      B      ", "     BBB     ", "   BBBBBBB   ", "    BBBBB    ", "     BBB     ", "             ", "             ")
                    .aisle(" ACCA   ACCA ", "             ", "    A B A    ", "    AB BA    ", "     B B     ", "   BBBBBBB   ", "  BCCBBBCCB  ", "   CC   CC   ", "   CC   CC   ", "   C     C   ", "             ")
                    .aisle("ACCA     ACCA", "  C   B   C  ", "  C  B B  C  ", "    A B A    ", "    A B A    ", "  B A C A B  ", " BCBBCCCBBCB ", "  CC     CC  ", "  C       C  ", "  C       C  ", "  C       C  ")
                    .aisle("ACA   B   ACA", "     B B     ", "      B      ", "   C     C   ", "   C CCC C   ", " B CCC CCC B ", "BCBC     CBCB", " CC       CC ", " C         C ", " C         C ", "             ")
                    .aisle("AA    B    AA", "A    B B    A", "AA    B    AA", " AA       AA ", "  A       A  ", " BAC     CAB ", "BCB       BCB", "BC         CB", " C         C ", "             ", "             ")
                    .aisle("     BBB     ", "   BBBBBBB   ", "  B   C   B  ", " B         B ", " B C     C B ", "BB C     C BB", "BBC       CBB", "B           B", "B           B", "             ", "             ")
                    .aisle("   BBBBBBB   ", "  B  BBB  B  ", " B BBCCCBB B ", "B B       B B", "B BC     CB B", "BBC       CBB", "BBC       CBB", "B           B", "B           B", "             ", "             ")
                    .aisle("     BBB     ", "   BBBBBBB   ", "  B   C   B  ", " B         B ", " B C     C B ", "BB C     C BB", "BBC       CBB", "B           B", "B           B", "             ", "             ")
                    .aisle("AA    B    AA", "A    B B    A", "AA    B    AA", " AA       AA ", "  A       A  ", " BAC     CAB ", "BCB       BCB", "BC         CB", " C         C ", "             ", "             ")
                    .aisle("ACA   B   ACA", "     B B     ", "      B      ", "   C     C   ", "   C CCC C   ", " B CCC CCC B ", "BCBC     CBCB", " CC       CC ", " C         C ", " C         C ", "             ")
                    .aisle("ACCA     ACCA", "  C   B   C  ", "  C  B B  C  ", "    A B A    ", "    A B A    ", "  B A C A B  ", " BCBBCCCBBCB ", "  CC     CC  ", "  C       C  ", "  C       C  ", "  C       C  ")
                    .aisle(" ACCA   ACCA ", "             ", "    A B A    ", "    AB BA    ", "     B B     ", "   BBBBBBB   ", "  BCCBBBCCB  ", "   CC   CC   ", "   CC   CC   ", "   C     C   ", "             ")
                    .aisle("  AAA   AAA  ", "    A   A    ", "    A   A    ", "      B      ", "      B      ", "     BBB     ", "   BBBBBBB   ", "    BBDBB    ", "     BBB     ", "             ", "             ")
