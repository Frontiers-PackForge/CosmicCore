...
import static com.ghostipedia.cosmiccore.common.data.CosmicBlocks.SELF_HEALING_PTHANTERUM;
...
public class VoraxReactor {
    public final static MultiblockMachineDefinition VORAX_REACTOR = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle(" AAAAAAAAA ", "    A A    ", "  AAA AAA  ", "    AAA    ", "   BBABB   ", "    BBB    ", "     B     ", "           ", "           ", "           ", "     B     ", "    BBB    ", "   BBABB   ", "    AAA    ", "  AAA AAA  ", "    A A    ", " AAAAAAAAA ")
                    .aisle("AA       AA", "  CCCACCC  ", " A  A A  A ", "   BAAAB   ", "  BB A BB  ", "           ", "           ", "           ", "           ", "           ", "           ", "           ", "  BB A BB  ", "   BAAAB   ", " A  A A  A ", "  CCCACCC  ", "AA       AA")
                    .aisle("A         A", " CCAAAAACC ", "A D A A D A", "  DBAAABD  ", " BD  A  DB ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", " BD  A  DB ", "  DBAAABD  ", "A D A A D A", " CCAAAAACC ", "A         A")
                    .aisle("A         A", " CAAAAAAAC ", "A  AA AA  A", " BBBAAABBB ", "BB  AEA  BB", "    AEA    ", "    AEA    ", "     E     ", "           ", "     E     ", "    AEA    ", "    AEA    ", "BB  AEA  BB", " BBBAAABBB ", "A  AA AA  A", " CAAAAAAAC ", "A         A")
                    .aisle("A         A", "ACAABBBAACA", "AAAAAAAAAAA", "AAAAAAAAAAA", "B  AFEFA  B", "B  AFEFA  B", "B  AFEFA  B", "B   EEE   B", "B         B", "B   EEE   B", "B  AFEFA  B", "B  AFEFA  B", "B  AFEFA  B", "AAAAAAAAAAA", "AAAAAAAAAAA", "ACAABBBAACA", "A         A")
                    .aisle("A         A", " AAABBBAAA ", "    AEA    ", "AAAAAEAAAAA", "AAAEEEEEAAA", "B  EEEEE  B", "B  EEEEE  B", "B  EEEEE  B", "B         B", "B  EEEEE  B", "B  EEEEE  B", "B  EEEEE  B", "AAAEEEEEAAA", "AAAAAEAAAAA", "    AEA    ", " AAABBBAAA ", "A         A")
                    .aisle("A         A", "ACAABBBAACA", "AAAAAAAAAAA", "AAAAAAAAAAA", "B  AFEFA  B", "B  AFEFA  B", "B  AFEFA  B", "B   EEE   B", "B         B", "B   EEE   B", "B  AFEFA  B", "B  AFEFA  B", "B  AFEFA  B", "AAAAAAAAAAA", "AAAAAAAAAAA", "ACAABBBAACA", "A         A")
                    .aisle("A         A", " CAAAAAAAC ", "A  AA AA  A", " BBBAAABBB ", "BB  AEA  BB", "    AEA    ", "    AEA    ", "     E     ", "           ", "     E     ", "    AEA    ", "    AEA    ", "BB  AEA  BB", " BBBAAABBB ", "A  AA AA  A", " CAAAAAAAC ", "A         A")
                    .aisle("A         A", " CCAAAAACC ", "A D A A D A", "  DBAAABD  ", " BD  A  DB ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", "  D     D  ", " BD  A  DB ", "  DBAAABD  ", "A D A A D A", " CCAAAAACC ", "A         A")
                    .aisle("AA       AA", "  CCCACCC  ", " A  A A  A ", "   BAAAB   ", "  BB A BB  ", "           ", "           ", "           ", "           ", "           ", "           ", "           ", "  BB A BB  ", "   BAAAB   ", " A  A A  A ", "  CCCACCC  ", "AA       AA")
                    .aisle(" AAAAAAAAA ", "    A A    ", "  AAA AAA  ", "    AAA    ", "   BBQBB   ", "    BBB    ", "     B     ", "           ", "           ", "           ", "     B     ", "    BBB    ", "   BBABB   ", "    AAA    ", "  AAA AAA  ", "    A A    ", " AAAAAAAAA ")
                    .where(' ', any())
