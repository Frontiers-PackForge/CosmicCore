...
public class CosmicStockingHatchPartMachine extends CosmicInputHatchPartMachine implements IMEStockingPart {
    ...
    private class ExportOnlyAEStockingFluidList extends ExportOnlyAEFluidList {
        ...
        public ExportOnlyAEStockingFluidList(MetaMachine holder, int slots) {
            super(holder, slots, CosmicStockingHatchPartMachine.ExportOnlyAEStockingFluidSlot::new);
        }
    ...
    private class ExportOnlyAEStockingFluidSlot extends ExportOnlyAEFluidSlot {
        ...
        public ExportOnlyAEFluidSlot copy() {
            return new CosmicStockingHatchPartMachine.ExportOnlyAEStockingFluidSlot(
