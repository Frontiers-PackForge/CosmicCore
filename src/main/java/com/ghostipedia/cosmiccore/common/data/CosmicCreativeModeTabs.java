...
public class CosmicCreativeModeTabs {
    ...
    public static RegistryEntry<CreativeModeTab> COSMIC_CORE_TINKERS_TOOLS = REGISTRATE.defaultCreativeTab(CosmicCore.MOD_ID,
                    builder -> builder
                            .displayItems(CosmicCreativeTinkersTab::addCreativeTabItems)
                            .title(REGISTRATE.addLang("itemGroup", CosmicCore.id("creative_tab_tinker_tools"), "Cosmic Core Tinkers Compat"))
