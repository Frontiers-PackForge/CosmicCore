...
public class CosmicLangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        replace(provider, "cosmiccore.multiblock.naqreactor.tooltip.0", "§cA massive reactor powered by explosions and reactive fuel");
        replace(provider, "cosmiccore.multiblock.naqreactor.tooltip.1", "§bWill always attempt to parallel to 16x output.");
