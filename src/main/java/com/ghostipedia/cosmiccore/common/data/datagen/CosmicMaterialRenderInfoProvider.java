...
public class CosmicMaterialRenderInfoProvider extends AbstractMaterialRenderInfoProvider {
    ...
    public CosmicMaterialRenderInfoProvider(PackOutput packOutput, @Nullable AbstractMaterialSpriteProvider
            materialSprites, @Nullable ExistingFileHelper existingFileHelper) {
