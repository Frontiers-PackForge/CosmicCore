    ...
    public static class MegaAlvearyRecipeLogic extends RecipeLogic {
        ...
        private Map<Fluid, Float> getProductivityFluids(){
            if(productivityFluids == null){
                ...
                productivityFluids.put(Fluids.LAVA, 2.0f);
        ...
        public @NotNull Iterator<GTRecipe> searchRecipe() {
            if(!(machine instanceof MegaAlvearyMultiblockMachine)){
                CosmicCore.LOGGER.error("MegaAlvearyRecipeLogic should only be ran in the MegaAlvearyMultiblockMachine");
            }
            ...
            for (var handler : fluidHandlers) {
                ...
                for (var content : fluidHandler.getContents()) {
                    ...
                    int drained = fluidHandler.drainInternal(new FluidStack(stack.getFluid(), productivityFluidConsumptionAmount), IFluidHandler.FluidAction.SIMULATE).getAmount();
