...
public class MegaAlvearyMultiblockMachine extends WorkableElectricMultiblockMachine {
    ...
    public static class MegaAlvearyRecipeLogic extends RecipeLogic {
        ...
        // Will consume X Nutrients at the start of the 5s cycle to 'boost' the yield, make sure this is extensible to like 4 or 5 fluids for now
        // Runs 5 seconds
        // Ejects all Products
        ...
        // Each Bee Installed in a bee holder will cost 1 ZPM amp - meaning atm the Best In Slot HONEY will draw 64A ZPM until V8+
        ...
        protected ActionResult handleRecipeIO(GTRecipe recipe, IO io) {
            ...
            //However because we are overriding handleIO it means we also need to properly rehandle the outputs i'd assume.
