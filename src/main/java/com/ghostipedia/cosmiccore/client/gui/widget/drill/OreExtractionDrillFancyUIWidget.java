...
public class OreExtractionDrillFancyUIWidget extends WidgetGroup {

    public OreExtractionDrillFancyUIWidget(Object mainPage, int width, int height, IntSupplier tierSupplier) {
 ...
 * 
 * public class OreExtractionDrillFancyUIWidget extends FancyMachineUIWidget {
 * 
 * private final IntSupplier tierSupplier;
 * 
 * private static final int BG_COLOR = 0xE00a0c10;
 * private static final int BORDER_COLOR = 0xFF404840;
 * private static final int SLOT_BG_COLOR = 0xC0101418;
 * private static final int SLOT_BORDER_COLOR = 0xFF505850;
 * 
 * private static final int[] TIER_COLORS = {
 * 0xFFC08040, // LV - Copper/Bronze
 * 0xFF60A0D0, // HV - Steel Blue
 * 0xFF8080C0, // IV - Titanium Purple
 * 0xFFD0A040 // ZPM - Tungsten Gold
 * };
 * 
 * public OreExtractionDrillFancyUIWidget(IFancyUIProvider mainPage, int width, int height, IntSupplier tierSupplier) {
 ...
 * 
 * DrawerHelper.drawGradientRect(graphics, x, y, w, h, 0xFF0c0e12, 0xFF080a0c, false);
