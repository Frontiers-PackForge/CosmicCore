...
public class SufferingChamberRender extends WorkableCasingMachineRenderer implements IControllerRenderer {

    public final ResourceLocation multipartSprite;

    public SufferingChamberRender(ResourceLocation texture, ResourceLocation multipartSprite,
