...
public class NebulaeCoilRenderer {
    ...
    // }
    //
    // public static NonNullFunction<BlockEntityRendererProvider.Context, BlockEntityRenderer<? super
    // CosmicCoilBlockEntity>> createBlockEntityRenderer() {
