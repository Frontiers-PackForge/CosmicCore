...
public class HellFireFoundryWorkableRenderer extends
                                             DynamicRender<WorkableElectricMultiblockMachine, HellFireFoundryWorkableRenderer> {

    public static final Codec<HellFireFoundryWorkableRenderer> CODEC = Codec.unit(HellFireFoundryWorkableRenderer::new);
    public static final DynamicRenderType<WorkableElectricMultiblockMachine, HellFireFoundryWorkableRenderer> TYPE = new DynamicRenderType<>(
            CODEC);
    ...
    //
    // @Override
    // public void renderPartModel(List<BakedQuad> quads, IMultiController machine, IMultiPart part, Direction
    // frontFacing,
    ...
    private void renderHellFire(WorkableElectricMultiblockMachine machine, PoseStack poseStack, VertexConsumer buffer) {
        ...
        RenderBufferHelper.renderRing(poseStack, buffer, 0.5F, 0, 5f, 6, 0.2f, 10, 20, 30, 30, 30, 60,
                machine.getFrontFacing().getAxis());
    }
}
