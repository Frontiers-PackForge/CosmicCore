...
public interface IPressureContainer {
    ...
    default boolean isNormalPressure() {
        return Math.abs(getPressure() - Statics.DEFAULT_PRESSURE) < PRESSURE_TOLERANCE;
    }
    ...
    default boolean isVacuum() {
        return getPressure() < Statics.DEFAULT_PRESSURE - PRESSURE_TOLERANCE;
    }
     ...
     */
    default void causePressureExplosion(Level world, BlockPos pos) {
    ...
    IPressureContainer EMPTY = new IPressureContainer() {
        ...
        public double getMinPressure() {
            return Statics.DEFAULT_PRESSURE / 2;
        }
