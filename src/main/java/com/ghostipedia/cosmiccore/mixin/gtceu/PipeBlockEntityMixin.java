...
public class PipeBlockEntityMixin implements IPipeBlockEntityMixin {
    ...
    public Pair<ToolDefinition, InteractionResult> ccore$onToolClick(ModifiableItem ticonItem, UseOnContext context) {
        ...
        if (ticonItem.getToolDefinition() == CosmicToolDefinitions.WRENCHES) {
            ...
            if (playerIn.isShiftKeyDown() && ((PipeBlockEntity<?, ?>) (Object) this).canHaveBlockedFaces()) {
            ...
            return Pair.of(CosmicToolDefinitions.WRENCHES,
                    InteractionResult.sidedSuccess(playerIn.level().isClientSide));
        }
